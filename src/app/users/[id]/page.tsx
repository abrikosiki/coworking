...
const MOCK_USER = {
  name: "Maria Santos",
  role: "Designer",
  bio: "Product designer with 5 years of experience. Passionate about clean interfaces and user research. Open to collabs! 🎨",
  email: "maria@cowork.com",
  linkedin: "linkedin.com/in/mariasantos",
  telegram: "@mariasantos",
  skills: ["Figma", "UI/UX", "Prototyping", "User Research", "Branding"],
  avatar: "MS",
  color: "#ec4899",
  checkedIn: true,
  since: "45m ago",
    ...
    <div style={s.page}>
      ...
      <main style={s.main}>
        ...
        <div style={s.heroCard}>
          <div style={{ ...s.heroBg, background: `radial-gradient(circle at 30% 50%, ${user.color}22, transparent 60%)` }} />

          <div style={s.heroContent}>
            <div style={s.avatarWrap}>
              <div style={{ ...s.avatar, background: user.color + "22", border: `3px solid ${user.color}55` }}>
            ...
            <div style={s.heroInfo}>
              ...
              <p style={s.heroBio}>{user.bio}</p>
            </div>

            {/* Quick stats */}
            <div style={s.heroStats}>
              <div style={s.heroStat}>
                <span style={s.heroStatVal}>{user.totalVisits}</span>
                <span style={s.heroStatLabel}>visits</span>
              </div>
              <div style={s.statDivider} />
              <div style={s.heroStat}>
                <span style={s.heroStatVal}>{user.memberSince}</span>
          ...
          <div style={s.card}>
            ...
            <div style={s.contacts}>
              {[
                ...
                { icon: "💼", label: "LinkedIn", value: user.linkedin, key: "linkedin" },
                { icon: "✈️", label: "Telegram", value: user.telegram, key: "telegram" },
...
const s: Record<string, React.CSSProperties> = {
  ...
  heroBadge: {
    ...
    color: "#a3e635", fontSize: 12, fontWeight: 600,
  ...
  heroInfo: { display: "flex", flexDirection: "column", gap: 10 },
  heroName: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 28, color: "#f1f5f9", letterSpacing: "-0.5px" },
  roleTag: { display: "inline-block", padding: "4px 12px", borderRadius: 8, fontSize: 12, fontWeight: 700, width: "fit-content" },
  ...
  heroStatVal: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 20, color: "#e2e8f0" },
